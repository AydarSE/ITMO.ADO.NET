...
{
    public partial class DAWizard : Form
    {
        public DAWizard()
        {
            InitializeComponent();
        ...
        private void DAWizard_Load(object sender, EventArgs e)
        {
        ...
        private void DAWizard_RowUpdating(object sender, System.Data.SqlClient.SqlRowUpdatingEventArgs e)
        {
        ...
        private void DAWizard_RowUpdated (object sender, System.Data.SqlClient.SqlRowUpdatedEventArgs e)
        {
            NorthwindDataSet.CustomersRow CustRow = (NorthwindDataSet.CustomersRow)e.Row;
        ...
        private void DAWizard_FillError (object sender, FillErrorEventArgs e)
        {

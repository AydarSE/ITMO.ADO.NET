...
namespace ITMO.ADO.NET.DataSourcesWizard.P05ex1.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITMO.ADO.NET.DataSourcesWizard.P05ex1.Properties.Settings.Default.NorthwindConnectionString;
        }
